...
class CambiarPasswordView(ft.Container):
    ...
    def __init__(self, page: ft.Page,  on_logout,  on_password_changed=None):
...
class CambiarPasswordView(ft.Container):
    ...
    # ==============================================================
    # NUEVO - MODO OBLIGATORIO
    # ==============================================================

    def set_modo_obligatorio(self, obligatorio=True):

        self.obligatorio = obligatorio

        if obligatorio:

            self.lbl_titulo.value = (
