...
class Sidebar(ft.Container):
    ...
    def menu_item(self, icon, title, route, permiso_ACCEDER= None):
...
class Sidebar(ft.Container):
    ...
    def build(self):
        ...
        if tiene_permiso(self.page_ref,"SUELDOS_ACCEDER"):

            if tiene_permiso(   self.page_ref, "SUELDOS_LIQUIDACION_ACCEDER"):
                sueldos_items.append(liquidacion)

            if tiene_permiso(self.page_ref,"SUELDOS_CONCEPTOS_ACCEDER"):
            ...
            if tiene_permiso("SUELDOS_NOVEDADES_ACCEDER"):
                sueldos_items.append(
                    self.menu_item(
                        ft.Icons.EDIT_NOTE_ROUNDED,
                        "Novedades",
    ...
    def build(self):
        ...
        liquidacion_items = [
            ...
            self.menu_item(
                ...
                "Datos fijos",
                "datos_fijos_liquidacion",
                "SUELDOS_LIQUIDACION_ACCEDER"  #  "SUELDOS_LIQUIDACION_DATOS_FIJOS_ACCEDER"
            ),
