...
class Sidebar(ft.Container):
    ...
    def menu_item(self, icon, title, route, permiso_ver= None):

        if permiso_ver is not None:
...
# =====================================================
        ...
        if tiene_permiso(self.page_ref,"SUELDOS_VER"):

            if tiene_permiso(   self.page_ref, "SUELDOS_LIQUIDACION_VER"):
                sueldos_items.append(liquidacion)

            if tiene_permiso(self.page_ref,"SUELDOS_CONCEPTOS_VER"):
            ...
            if tiene_permiso("SUELDOS_NOVEDADES_VER"):
                sueldos_items.append(
                    self.menu_item(
                        ft.Icons.EDIT_NOTE_ROUNDED,
                        "Novedades",
